...
// import knowyourtown.motivation.ClientMotivation;
...
public class StorageImplementation implements Storage 
{
    ...
    public String getQuote(){
        try{
            String ENDPOINT = "http://127.0.1.1:5700/motivation/adapter/getQuote";
    ...
    public String getQuote2(){
        try{
            String ENDPOINT = "http://127.0.1.1:5700/motivation/adapter/getQuote2";
            DefaultHttpClient client = new DefaultHttpClient();
            HttpGet request = new HttpGet(ENDPOINT);
            HttpResponse response = client.execute(request);
